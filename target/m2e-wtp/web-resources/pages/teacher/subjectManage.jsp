			...
			<div class="col-xs-10">
				...
				<c:if test="${!empty requestScope.mySubjects }">
					<table class="table table-bordered text-center"
						...
						<tbody>
							<c:forEach items="${requestScope.mySubjects }" var="subject" varStatus="status">
							<tr style="color: black;" id="teacherSubject${subject.graduationSubjectId}">
								<form>
										...
										<td>
											<button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#edit${subject.graduationSubjectId }">修改</button>
											<a href="${pageContext.request.contextPath}/teacherSubject/deleteSubject/${subject.graduationSubjectId}" class="btn btn-primary btn-sm deleteSubject">删除</button>
										</td>
								</form>
							</tr>
								<!-- Model Begin -->
